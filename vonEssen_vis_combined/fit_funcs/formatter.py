class FormatParams: 
    ...
    def __init__(self, params, data):
        ...
        self.phi32 = params[data.par_order['phi32']*data.nvisit:(1 + data.par_order['phi32'])*data.nvisit]
...
def PrintParams(m, data): 
    ...
    print "phi32\t", m.params[data.par_order['phi32']*data.nvisit:(1 + data.par_order['phi32'])*data.nvisit]
