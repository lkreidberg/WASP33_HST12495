class FormatParams: 
    ...
    def __init__(self, params, data):
        ...
        self.r12 = params[data.par_order['r12']*data.nvisit:(1 + data.par_order['r12'])*data.nvisit]
        self.r22 = params[data.par_order['r22']*data.nvisit:(1 + data.par_order['r22'])*data.nvisit]
        self.r32 = params[data.par_order['r32']*data.nvisit:(1 + data.par_order['r32'])*data.nvisit]
        ...
        self.phi12 = params[data.par_order['phi12']*data.nvisit:(1 + data.par_order['phi12'])*data.nvisit]
        ...
        self.phi22 = params[data.par_order['phi22']*data.nvisit:(1 + data.par_order['phi22'])*data.nvisit]
...
def PrintParams(m, data): 
    ...
    print "r12\t", m.params[data.par_order['r12']*data.nvisit:(1 + data.par_order['r12'])*data.nvisit]
    print "r22\t", m.params[data.par_order['r22']*data.nvisit:(1 + data.par_order['r22'])*data.nvisit]
    print "r32\t", m.params[data.par_order['r32']*data.nvisit:(1 + data.par_order['r32'])*data.nvisit]
    ...
    print "a12\t", m.params[data.par_order['a12']*data.nvisit:(1 + data.par_order['a12'])*data.nvisit]
    print "omega12\t", m.params[data.par_order['omega12']*data.nvisit:(1 + data.par_order['omega12'])*data.nvisit]
    print "phi12\t", m.params[data.par_order['phi12']*data.nvisit:(1 + data.par_order['phi12'])*data.nvisit]
    print "a22\t", m.params[data.par_order['a22']*data.nvisit:(1 + data.par_order['a22'])*data.nvisit]
    print "omega22\t", m.params[data.par_order['omega22']*data.nvisit:(1 + data.par_order['omega22'])*data.nvisit]
    print "phi22\t", m.params[data.par_order['phi22']*data.nvisit:(1 + data.par_order['phi22'])*data.nvisit]
