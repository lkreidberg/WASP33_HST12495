...
def PrintParams(m, data): 
    ...
    print "b1\t", m.params[data.par_order['b1']*data.nvisit:(1 + data.par_order['b1'])*data.nvisit]
    ...
    print "b2\t", m.params[data.par_order['b2']*data.nvisit:(1 + data.par_order['b2'])*data.nvisit]
    ...
    print "b3\t", m.params[data.par_order['b3']*data.nvisit:(1 + data.par_order['b3'])*data.nvisit]
    ...
    print "b12\t", m.params[data.par_order['b12']*data.nvisit:(1 + data.par_order['b12'])*data.nvisit]
    ...
    print "b22\t", m.params[data.par_order['b22']*data.nvisit:(1 + data.par_order['b22'])*data.nvisit]
    print "a32\t", m.params[data.par_order['a32']*data.nvisit:(1 + data.par_order['a32'])*data.nvisit]
    print "omega32\t", m.params[data.par_order['omega32']*data.nvisit:(1 + data.par_order['omega32'])*data.nvisit]
    print "b32\t", m.params[data.par_order['b32']*data.nvisit:(1 + data.par_order['b32'])*data.nvisit]
    ...
    print "cRate\t", m.params[data.par_order['cRate']*data.nvisit:(1 + data.par_order['cRate'])*data.nvisit]
