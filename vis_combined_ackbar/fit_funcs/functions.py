        ...
        for f in funcs:
            if f == "constant":
                ...
                self.sys_porder.append([
                    ...
                    data.par_order['cRate']*data.nvisit
                ]) 
            elif f == "divide_white":
