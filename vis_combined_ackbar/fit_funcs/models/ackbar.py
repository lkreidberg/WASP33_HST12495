...
def ackbar(t, data, params, visit = 0):
    ...
    """
    trap_pop_s, trap_pop_f, dTrap_s, dTrap_f, cRate = params
    ...
    cRates = cRate*np.ones_like(t)              #calculate this based on white light average (need to do better! FIXME) 
    tExp = (t - t[0])*24.*60.*60.
    ...
    #print (obsCounts/np.max(obsCounts))
